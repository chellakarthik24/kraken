...
//    final List<WebClient> webClients;
    ...
    public KrakenEventListenerProvider(/*final List<WebClient> webClients*/) {
        /*this.webClients = requireNonNull(webClients);*/
    }
...
//            webClient.post()
//                    .body(BodyInserters.fromFormData("userId", event.getUserId()))
//                    .exchange();
//        }
    }
